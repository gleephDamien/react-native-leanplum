...
var RNPushNotification = NativeModules.LPPushNotif;
...
NotificationsComponent.prototype.setApplicationIconBadgeNumber = function(n: number) {
	/*if (!RNPushNotification.setApplicationIconBadgeNumber) {
		return;
	}*/
	RNPushNotification.setApplicationIconBadgeNumber(n);
};
