...
import static com.reactnativeleanplum.push.modules.RNPushNotificationAttributes.fromJson;
...
public class RNPushNotificationHelper {
    ...
    private void checkOrCreateChannel(NotificationManager manager) {
        ...
        NotificationChannel channel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, this.config.getChannelName(), this.config.getChannelImportance());
